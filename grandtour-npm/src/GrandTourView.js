...
export class GrandTourView {
    ...
    constructor(kwargs){
        ...
        //style
        this.bgColor = [40/255,41/255,35/255];
        this.alphaUnselected = 30;
        ...
        .on('brush', ()=>{
            ...
            if(s !== null){
                ...
                for(let i=0; i<this.npoint; i++){
                    ...
                    c[3] = selected ? 255 : this.alphaUnselected; //update color
                    //update centroid
                    if(selected){
                        count += 1;
    ...
    initGL(){
        ...
        if (!Array.isArray(this.color)){
            ...
            this.color = d3.range(this.npoint).map(d=>[...c, 255]);
        }
        this.updateColor(this.color);
    ...
    plot(dt){
        ...
        if(this.mode == 'line'){
            gl.uniform1i(this.webgl.modeLoc, 1);
            gl.drawArrays(gl.LINES, 0, this.npoint);
            gl.drawArrays(gl.LINES, 1, this.npoint-1);
        }
        gl.uniform1i(this.webgl.modeLoc, 0);
